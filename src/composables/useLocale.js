...
const dict = {
  ru: {
    ...
    allWeaknesses: 'Все слабости',
    weakIgni: 'Игни',
    weakAard: 'Аард',
    weakYrden: 'Ирден',
    weakAxii: 'Аксий',
    weakQuen: 'Квен',
    weakMoonDust: 'Лунная пыль',
    weakBlackBlood: 'Черная кровь',
    weakDimeritium: 'Димеритиевая бомба',
    weakGrapeshot: 'Картечь',
    weakCrossbow: 'Арбалет',
    weakBeastOil: 'Масло против зверей',
    weakVampireOil: 'Масло против вампиров',
    weakHybridOil: 'Масло против гибридов',
    weakDraconidOil: 'Масло против драконидов',
    weakElementaOil: 'Масло против элементалей',
    weakInsectoidOil: 'Масло против инсектоидов',
    weakOgroidOil: 'Масло против огров',
    weakCursedOil: 'Масло против проклятых',
    weakRelictOil: 'Масло против реликтов',
    weakNecrophageOil: 'Масло против трупоедов',
  ...
  en: {
    ...
    allWeaknesses: 'All weaknesses',
    weakIgni: 'Igni',
    weakAard: 'Aard',
    weakYrden: 'Yrden',
    weakAxii: 'Axii',
    weakQuen: 'Quen',
    weakMoonDust: 'Moon Dust',
    weakBlackBlood: 'Black Blood',
    weakDimeritium: 'Dimeritium Bomb',
    weakGrapeshot: 'Grapeshot',
    weakCrossbow: 'Crossbow',
    weakBeastOil: 'Beast Oil',
    weakVampireOil: 'Vampire Oil',
    weakHybridOil: 'Hybrid Oil',
    weakDraconidOil: 'Draconid Oil',
    weakElementaOil: 'Elementa Oil',
    weakInsectoidOil: 'Insectoid Oil',
    weakOgroidOil: 'Ogroid Oil',
    weakCursedOil: 'Cursed Oil',
    weakRelictOil: 'Relict Oil',
    weakNecrophageOil: 'Necrophage Oil',
